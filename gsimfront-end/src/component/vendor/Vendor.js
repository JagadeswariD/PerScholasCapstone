          ...
          <Card>
                ...
                <Card.Body>
                      <Form.Group className="mb-3">
                           ...
                           <Form.Control required type="text" placeholder="Enter vendor first name"  name="vendorFirstName"  value={vendor.vendorFirstName} onChange={handleChange}/>
                       </Form.Group>
                       <Form.Group className="mb-3">
                            <Form.Label>Last Name</Form.Label>
                            <Form.Control required type="text" placeholder="Enter vendor last name" name="vendorLastName" value={vendor.vendorLastName} onChange={handleChange}/>
                       </Form.Group>
                       <Form.Group className="mb-3" controlId="formBasicEmail">
                             <Form.Label>Email address</Form.Label>
                             <Form.Control required type="email" placeholder="Enter vendor email" name="vendorEmail" value={vendor.vendorEmail} onChange={handleChange}/>
